...
export const Stars: Star[] = [
  ...
  },
  {
    name: "Эпсилон Эридана",
      description:
      "Одно из важнейших приобретений корпорации Нанотрейзен в послевоенный период, система Эпсилон Эридана представляет собой стратегический и научный узел исключительного значения. Она известна своим нестабильным блюспейс-полем, порождающим огромное количество аномалий, штормов и феноменов всех типов и масштабов, а также богатейшими залежами плазмы и синих кристаллов, обнаруженными практически на каждом астрономическом теле системы. В настоящий момент в системе размещено значительное число научных и добывающих объектов Компании, включая станции тринадцатого проекта. Оборону региона обеспечивает группировка «Воля Трейзена» — крупнейшее формирование Флота Нанотрейзен, регулярно отражающее атаки пиратов, воксов-рейдеров и сил Синдиката.",
    planets: [
      Planets.LasisArdaks,
      Planets.Agir,
    ],
