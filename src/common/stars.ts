...
export const Stars: Star[] = [
  ...
  },
  {
    name: "Нюфен",
    description:
      "Система Ню Феникса — звёздная система, сформированная вокруг солнцеподобной звезды с выраженным осколочным диском. В её пределах отмечается огромное количество блюспейс-аномалий, число которых стало стремительно расти с 2390-х годов. Их плотность и непредсказуемость достигли таких масштабов, что дальнейшее освоение системы оказалось практически невозможным. В настоящий момент Ню Феникс посещают лишь редко и с большим риском — сюда заходят корабли мусорщиков и воксов, использующих опасные аномалии в своих целях.",
    planets: [
      Planets.Hirkha],
    affiliation: Nations.Free,
    type: STAR_TYPE.Controversial,
