...
export const Stars: Star[] = [
  ...
  },
  {
    name: "Фертил",
    description:
      "Звезда одноименной системы, желтый карлик. Центральный административный мир \”Плодородного пояса\” ТСФ. Система и находящиеся в ней корпорации значительно пострадали во время Великой Межсистемной войны, однако была восстановлена в рекордные сроки за счет колоссальных вложений со стороны государства.",
    planets: [
      Planets.Ninhursag,
      Planets.Ninurta],
    affiliation: Nations.TSF,
