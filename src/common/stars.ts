...
export const Stars: Star[] = [
  ...
  },
  {
    ...
    planets: [Planets.Urlum, Planets.MouunLum, Planets.RouunLum],
  ...
  },
  {
    ...
    planets: [Planets.Langobardia, Planets.Citra],
    affiliation: Nations.TSF,
    type: STAR_TYPE.Controlled,
  ...
  },
  {
    ...
    planets: [Planets.Juno, Planets.Athena],
    affiliation: Nations.TSF,
    type: STAR_TYPE.Controlled,
  ...
  {
    name: 'Веридиус',
    description: 'Звезда одноименной системы, красный карлик. Приграничная система ТСФ, ничем не примечательная.',
    planets: [Planets.Raine],
    affiliation: Nations.TSF,
    type: STAR_TYPE.Controlled,
  ...
  },
  {
    ...
    planets: [Planets.Arkadia, Planets.NewCanaan],
    affiliation: Nations.TSF,
    type: STAR_TYPE.Controlled,
  ...
  },
  {
    ...
    planets: [Planets.Ninhursag, Planets.Ninurta],
    affiliation: Nations.TSF,
    type: STAR_TYPE.Controlled,
  ...
  },
  {
    ...
    planets: [Planets.Vorat, Planets.Lavra],
    affiliation: Nations.TSF,
    type: STAR_TYPE.Controlled,
  ...
  },
  {
    ...
    description: 'Звезда одноименной системы, ничем не примечательный мир.',
    planets: [Planets.AlKhazraj],
    affiliation: Nations.TSF,
    type: STAR_TYPE.Controlled,
  ...
  },
  {
    ...
    planets: [Planets.Boron, Planets.BoronII],
    affiliation: Nations.TSF,
    type: STAR_TYPE.Capital,
  ...
  },
  {
    ...
    planets: [Planets.LasisArdaks, Planets.Agir],
  ...
  },
  {
    ...
    planets: [Planets.Prometheus, Planets.Pandora],
    affiliation: Nations.Nanotrasen,
    type: STAR_TYPE.Controlled,
  ...
  },
  {
    ...
    planets: [Planets.Aurum, Planets.Ree, Planets.DeltaMazz],
  ...
  },
  {
    ...
    planets: [Planets.Moges, Planets.Sirsh, Planets.Lirash],
  ...
  },
  {
    ...
    planets: [Planets.Khiram, Planets.Adomai, Planets.Iluk, Planets.Ramaja],
    affiliation: Nations.Free,
    type: STAR_TYPE.Capital,
  ...
  },
  {
    name: 'Дельта Эридана',
    description:
      'Двойная звёздная система, состоящая из двух красных карликов. Единственная система, перешедшая под контроль Вольных Секторов по итогам Великой Межсистемной войны благодаря появлению здесь в 2536 году крупного рейдерского флота Триады. Сегодня в системе отмечается активный трафик судов различных государств и корпораций.',
    planets: [Planets.GroundFerrum],
    affiliation: Nations.Free,
    type: STAR_TYPE.Controversial,
  ...
  },
  {
    name: 'Кессея',
    description:
      'Система Кессея — бинарная звёздная система, состоящая из белого карлика Кессея A и нейтронной звезды Кессея B, вращающихся вокруг общего центра масс на расстоянии около 0,5 а.е. Белый карлик, остаток бывшей звезды главной последовательности, излучает слабый, но стабильный ультрафиолетовый свет, создавая призрачный синий оттенок в небе планет системы. Нейтронная звезда, компактный и крайне плотный объект с мощным магнитным полем, периодически испускает рентгеновские вспышки и пульсирующие радиоволны, влияя на атмосферы и климаты всех миров в системе. Эта необычная пара делает Кессею объектом интереса для астрофизиков и корпораций, таких как Нанотрайзен. Система включает четыре планеты, каждая из которых адаптирована к суровым условиям бинарного танца звёзд, с орбитами, стабилизированными гравитационными взаимодействиями.',
    planets: [Planets.Ayrone, Planets.Avafeus, Planets.Violet, Planets.Zaratus],
    affiliation: Nations.Free,
    type: STAR_TYPE.Controversial,
  ...
  },
  {
    name: 'Брессер',
    description:
      'Звезда одноимённой системы, тусклый оранжевый карлик. Обладая стабильными характеристиками и некоторым сходством с Солнцем, она, однако, излучает значительно меньше тепловой энергии, чем последнее. Это определяет суровый, прохладный климат большинства планет, находящихся в зоне обитаемости. Система является одним из перевалочных пунктов на пути к дальним рубежам неизведанного космоса. Большую часть инфраструктуры системы контролируется правительствами, корпорациями и частниками-выходцами Вольных Секторов.',
    planets: [Planets.Miriam, Planets.Kolfman, Planets.Gregor, Planets.Anselm],
    affiliation: Nations.Free,
    type: STAR_TYPE.Controversial,
  ...
  },
  {
    name: 'Аркан',
    description:
      'Одиночная звезда класса жёлтый карлик. Отдалённый пограничный мир Вольных Секторов, служащий перевалочным пунктом к системам за пределами известной Галактики. Трафик в системе невелик, в основном его составляют суда корпораций Вольных Секторов и Нанотрейзен.',
    planets: [Planets.Inka, Planets.Nemeina],
    affiliation: Nations.Free,
    type: STAR_TYPE.Controversial,
    position: { x: 205, y: 732 },
  },
  {
    name: 'Звезда ван Маанена',
    affiliation: Nations.Free,
    type: STAR_TYPE.Controversial,
  ...
  },
  {
    name: 'Эхо-Лира',
    description:
      'Уникальная тройная звёздная система, состоящая из красного карлика, вращающегося вокруг чрезвычайно горячей звезды, окутанной протозвёздным облаком, из-за чего её свечение с далёких расстояний воспринимается как фиолетовое. Третьим компонентом выступает массивная синяя звезда-спутник, образующая с парой сложный гравитационный узел. Система отличается крайне нестабильной средой: протозвёздное облако и излучение горячей звезды создают мощные магнитные аномалии, усугубляемые активными блюспейс-разломами. Из-за этого Эхо-Лира почти не используется как транспортный узел. Корабли появляются здесь крайне редко - раз в десятки лет, и то либо случайно, либо в отчаянной попытке укрыться от преследования.',
    planets: [Planets.NewHarmony],
    affiliation: Nations.Free,
    type: STAR_TYPE.Controversial,
  ...
  },
  {
    name: 'Долина Феникса',
    description:
      'Система Долины Феникса - звёздная система, сформированная вокруг солнцеподобной звезды с выраженным осколочным диском. В её пределах отмечается огромное количество блюспейс-аномалий, число которых стало стремительно расти с 2390-х годов. Их плотность и непредсказуемость достигли таких масштабов, что дальнейшее освоение системы оказалось практически невозможным. В настоящий момент Долину Феникса посещают лишь редко и с большим риском - сюда заходят корабли мусорщиков и воксов, использующих опасные аномалии в своих целях.',
    planets: [Planets.Hirkha],
    affiliation: Nations.Free,
    type: STAR_TYPE.Controversial,
  ...
  },
  {
    name: 'Порта',
    description:
      'Тройная звёздная система, состоящая из трёх равномассных красных карликов, приграничный регион Республики Эллизиум. Близость к Вольным Секторам делает систему одним из самых неспокойных участков – здесь постоянно активны наёмники и пираты, а через саму систему идёт практически неконтролируемый двухсторонний поток контрабанды и вооружения. Несмотря на статус крупного военного центра Республики, местные власти крайне неохотно перекрывают поставки, что, по всей видимости, связано с негласной политикой \”тесного содружества\” между Триадой и правительством Великого Понтифика. В системе расположено множество транзитных узлов, крупных торговых станций и рекреационных комплексов, среди которых - руины известного гранд-отеля "Эллипсоид", разрушенного в 2569 году.',
    planets: [Planets.Asteria],
    affiliation: Nations.Elysium,
    type: STAR_TYPE.Controlled,
  ...
  },
  {
    ...
    planets: [Planets.Pioneer, Planets.PioneerII, Planets.Lasarys, Planets.Udarnyik],
  ...
  {
    name: 'Вега',
    description: 'Звезда одноименной системы, желтый карлик. Малопримечательный приграничный мир КССП.',
    planets: [Planets.Viyara, Planets.ViyaraII],
    affiliation: Nations.CUSP,
    type: STAR_TYPE.Controlled,
  ...
  },
  {
    ...
    planets: [Planets.Avangard17, Planets.Polus],
    affiliation: Nations.CUSP,
    type: STAR_TYPE.Controlled,
